      ...
      <b-row class=""> 
          ...
          <b-button-group class="col-sm-12"> 
              <basic-select
                ...
                <b-button @click="agregarServicios" variant="dark" size="sm">Importar&nbsp;servicios</b-button>
            </b-button-group>
          </b-col>
        </b-row>
    </b-modal>
...
export default {
  ...
  methods:{
    ...mapActions('cotizaciones', ['getTipoEnsayo', 'getTipoMuestra', 'getTipoDigestion', 'getTipoTecnica', 'getServicios', 'setServicios', 'deleteServiceAgregado', 'addServiceElegido', 'finalizar', 'getAllCotizaciones']),
