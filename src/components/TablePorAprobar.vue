    ...
    <b-row>
        <b-table
            ...
            <b-button-group size="sm">
                ...
                <b-button variant="success" @click="aprobarVenta(row.item)">Aprobar (Venta)</b-button>
                <b-button variant="success" @click="aprobarProduccion(row.item)">Aprobar (Produccion)</b-button>
            </b-button-group>
            </template>
